                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="flex items-center justify-center w-auto h-8 bg-gradient-to-r from-red-600 to-red-700 rounded-lg">
                                <img
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-50 rounded-lg">
                                ...
                                <span className="text-xs bg-blue-100 text-red-800 px-2 py-0.5 rounded uppercase font-medium">
                                    {user?.role}
                                </span>
                            </div>
            ...
            <footer className="bg-white border-t mt-auto">
                <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center text-sm text-gray-600">
                        <p>© 2025 WheelsNow. All rights reserved.</p>
                        <div className="flex items-center gap-4">
